...
# One notification block per division, filtered by the literal, static prefix
# bronze/<division>/ (SPEC-003/SPEC-004 — division comes before the variable
# date segment, which is what makes filter_prefix work at all).
