...
from src.generators.common import build_faker, generate_row, maybe_corrupt  # noqa: E402
from src.generators.divisions import DIVISION_ORDER, DIVISIONS  # noqa: E402
from src.generators.uploader import upload_to_bronze  # noqa: E402
...
def generate_division(
    ...
    for _ in range(rows):
        ...
        row = maybe_corrupt(row, division, error_rate)
        records.append(row)
